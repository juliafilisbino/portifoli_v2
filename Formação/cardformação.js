export class CriadorCards {
    ...
    async criarCards() {
        const response = await fetch('https://backend-portif-lio.vercel.app/pegaCardsFormação');
    ...
    async addCard() {
        ...
        const response = await fetch('https://backend-portif-lio.vercel.app/addCardFormação', {
            method: 'POST',
            headers: {
    ...
    async removerCard(cardId) {
        const response = await fetch('https://backend-portif-lio.vercel.app/deleteCardFormação', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
