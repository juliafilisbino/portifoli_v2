export class CriadorCards {
    ...
    async criarCards() {
        const response = await fetch('https://backend-portif-lio.vercel.app/pegaCards');
    ...
    async addCard() {
        ...
        const response = await fetch('https://backend-portif-lio.vercel.app/addCard', {
            method: 'POST',
            headers: {
    ...
    async removerCard(cardId) {
        const response = await fetch('https://backend-portif-lio.vercel.app/deleteCard', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
